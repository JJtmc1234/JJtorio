...
local TECHS = {
  ...
  { id = "mass-assembly",      label = "Mass Assembly",        build = "assembling-machine-2",   count = 200 },
  { id = "advanced-assembly",  label = "Advanced Assembly",    build = "assembling-machine-3",   count = 100 },
  { id = "smelting-scale",     label = "Smelting Scale",       build = "electric-furnace",       count = 100 },
  { id = "solar-farm",         label = "Solar Farm",           build = "solar-panel",            count = 200 },
  { id = "storage-bank",       label = "Storage Bank",         build = "accumulator",            count = 100 },
  { id = "research-campus",    label = "Research Campus",      build = "lab",                    count = 50 },
  { id = "beacon-grid",        label = "Beacon Grid",          build = "beacon",                 count = 50 },
  { id = "defense-line",       label = "Defense Line",         build = "gun-turret",             count = 100 },
  { id = "recon-network",      label = "Recon Network",        build = "radar",                  count = 20 },
}
