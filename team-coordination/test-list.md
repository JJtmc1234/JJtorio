...
[ ] 8. Rocket Science tier (0.1.10). This release adds a new science pack and
       techs, so first confirm the mod still LOADS. Then in the tech tree find
       Rocket Science after the rocket silo, research it, craft the Rocket
       Science pack, and confirm labs accept it and the draft techs appear.
